    ...
    >
        ...
        >
            ...
            >
                ...
                <div class="py-3 pr-4">
                    <ul>
                        <SidebarLink name="Dashboard" href="#" :active="$page.url === '/admin'">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                        </SidebarLink>
                        <SidebarLink name="Partner" href="#" :active="$page.url === '/admin/partner'">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                        </SidebarLink>
                        <SidebarLink name="Partner Produk" href="#" :active="$page.url === '/admin/partner-produk'">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m1.5.5l-1.5-.5M6.75 7.364V3h-3v18m3-13.636l10.5-3.819" />
                        </SidebarLink>
                        <SidebarLink name="Request QR" href="#" :active="$page.url === '/admin/request-qr'">
                        ...
                        <SidebarLink name="Customer Data" href="#" :active="$page.url === '/admin/customer'">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0l-5.571 3-5.571-3" />
                        </SidebarLink>
                        <SidebarLink name="Kontak" href="#" :active="$page.url === '/admin/kontak'">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
                        </SidebarLink>
                        <SidebarLink name="Report" href="#" :active="$page.url === '/admin/report'">
                        ...
                        <SidebarDropdownLink href="#" name="Master Data" :openedMenu="openedMenu" :active="$page.url.startsWith('/admin/master-data')" @handleOpenMenu="openMenu('Master Data')">
                            ...
                            <Link href="#">
                                <li class="hover:text-purple-1100 py-2" :class="{ 'text-purple-1100': $page.url === '/admin/master-data/kategori-produk' }">Kategori Produk</li>
                            </Link>
                            <Link href="#">
                                <li class="hover:text-purple-1100 py-2" :class="{ 'text-purple-1100': $page.url === '/admin/master-data/type-qr' }">Type QR</li>
                            </Link>
                        </SidebarDropdownLink>
                        <SidebarDropdownLink href="#" name="Utilities" :openedMenu="openedMenu" :active="$page.url.startsWith('/admin/utilities')" @handleOpenMenu="openMenu('Utilities')">
                            ...
                            <Link href="#">
                                <li class="hover:text-purple-1100 py-2" :class="{ 'text-purple-1100': $page.url === '/admin/utilities/user' }">User</li>
                            </Link>
                            <Link href="#">
                                <li class="hover:text-purple-1100 py-2" :class="{ 'text-purple-1100': $page.url === '/admin/utilities/role' }">Role</li>
                            </Link>
                            <Link href="#">
                                <li class="hover:text-purple-1100 py-2" :class="{ 'text-purple-1100': $page.url === '/admin/utilities/setting' }">Setting</li>
                            </Link>
                        </SidebarDropdownLink>
                    </ul>
                </div>
