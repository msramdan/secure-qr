            ...
            >
                <div v-if="openUserOption" class="absolute right-0 mt-0.5 bg-white shadow-main w-72 rounded-xl">
                    ...
                    <div class="flex justify-center p-4">
                        <Link :href="route('logout')" method="post" class="bg-gradient-to-r from-purple-dashboard-gradient-1 to-purple-dashboard-gradient-2 flex items-center space-x-2 px-4 py-2 rounded-xl text-white">
