    ...
    <header class="sticky top-0 bg-dashboard pt-5 rounded-b-2xl z-50">
        <div class="bg-white rounded-2xl shadow-dashboard-card mb-5">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex items-center justify-end space-x-4 md:space-x-5">
                    <div class="flex items-center space-x-4 md:space-x-5 text-purple-1100">
                    ...
                    <div @click="openUserOption = !openUserOption" class="bg-gradient-to-l lg:bg-gradient-to-r from-purple-dashboard-gradient-2 to-purple-dashboard-gradient-1 px-3.5 py-3 rounded-2xl cursor-pointer">
                        <div class="flex items-center space-x-4">
                            <div>
                                <img :src="user1" alt="User" class="w-12 rounded-2xl">
                            </div>
                            <div class="hidden lg:block text-white">
                                <h6 class="text-xl">Nik Jone</h6>
            ...
            >
                <div v-if="openUserOption" class="absolute right-0 bg-white shadow-main w-72 rounded-xl">
                    ...
                    <div class="flex justify-center p-4">
                        <Link :href="route('logout')" method="post" as="button" type="button" class="bg-gradient-to-r from-purple-dashboard-gradient-1 to-purple-dashboard-gradient-2 flex items-center space-x-2 px-4 py-2 rounded-xl text-white">
