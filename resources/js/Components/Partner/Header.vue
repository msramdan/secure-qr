        ...
        <div class="bg-white rounded-xl shadow-main px-5 py-4 mb-5">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <ul class="hidden xl:flex items-center space-x-10 overflow-x-auto">
                    <HeaderLink name="Dashboard" href="/panel/dashboard" :active="$page.url === '/partner/dashboard'">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                    </HeaderLink>
                    <HeaderLink name="Bisnis" href="#" :active="$page.url === ''">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205l3 1m1.5.5l-1.5-.5M6.75 7.364V3h-3v18m3-13.636l10.5-3.819" />
                    </HeaderLink>
                    <HeaderLink name="Produk" href="#" :active="$page.url === ''">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
                    </HeaderLink>
                    <HeaderLink name="Request QR" href="#" :active="$page.url === ''">
                    ...
                    <HeaderLink name="Profile" href="#" :active="$page.url === ''">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                    </HeaderLink>
                    <HeaderLink name="Customer Data" href="#" :active="$page.url === ''">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0l-5.571 3-5.571-3" />
                    </HeaderLink>
                    <HeaderLink name="Custom Link Resmi" href="#" :active="$page.url === ''">
                ...
                <div class="flex items-center justify-end space-x-4 xl:space-x-5">
                    <div class="flex items-center space-x-4 xl:space-x-5 text-purple-1100">
                        ...
                        <!-- <button class="lg:hidden bg-dashboard flex items-center justify-center w-10 h-10 rounded-lg focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                            </svg>
                        </button> -->
                    </div>
                    <img @click="openUserOption = !openUserOption" :src="user1" alt="User" class="w-12 rounded-xl cursor-pointer">
                </div>
            </div>
            <transition
