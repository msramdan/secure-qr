            ...
            >
                <div class="sticky top-0 bg-white">
                    <div class="flex items-center space-x-5 px-5 py-3.5">
                        <div>
                            <img src="https://labelin.co/storage/img/setting_web/t9ebqSFalSmrWatWVjMNRomoFxa5KfJg9AYurwSE.png" alt="Logo" class="xl:w-48">
                        </div>
                        <button @click="closeSidebar" class="xl:hidden bg-dashboard flex-none flex items-center justify-center w-10 h-10 rounded-lg focus:outline-none">
                ...
                <div class="py-3 pr-4">
                    <ul>
                        ...
                        <SidebarLink name="Customer Data" href="/partner/cutomer_data" :active="$page.url === '/partner/cutomer_data'">
