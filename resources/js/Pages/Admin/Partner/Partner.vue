...
<template>
    ...
    <AdminLayout>
        <div class="bg-white p-4 lg:p-6 rounded-2xl shadow-main">
            <h2 class="font-bold text-lg mb-5">Data Partner</h2>
            <ButtonCreate/>
                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left border p-3 truncate">Nama</th>
                            <th class="text-left border p-3 truncate">Email</th>
                            <th class="text-left border p-3 truncate">Telepon</th>
                            <th class="text-left border p-3 truncate">Gambar</th>
