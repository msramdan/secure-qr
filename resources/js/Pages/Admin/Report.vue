...
<template>
    ...
    <AdminLayout>
        <div class="bg-white p-4 lg:p-6 rounded-2xl shadow-main">
            <h2 class="font-bold text-lg mb-5">Data Report</h2>
            <div class="w-full overflow-x-auto">
                <table class="w-full table-auto">
                    <thead>
                        <tr>
                            <th class="text-left border p-3 truncate">No</th>
                            <th class="text-left border p-3 truncate">Nama Lengkap</th>
                            <th class="text-left border p-3 truncate">Nomor Telepon</th>
                            <th class="text-left border p-3 truncate">Kronologi</th>
