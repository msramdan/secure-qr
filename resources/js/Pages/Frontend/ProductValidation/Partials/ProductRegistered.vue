...
<template>
    <ValidationLayout>
        ...
        <!-- Media Sosial -->
        <div class="mb-10">
            <div class="font-bold text-center mb-5">Follow us!</div>
            <ul class="list-group">
                <li class="flex items-center px-5 py-3 my-2.5 border rounded">
